...
#ifndef PLAN_EXECUTE_INTERFACE__SRV__DETAIL__PLACE__FUNCTIONS_H_
#define PLAN_EXECUTE_INTERFACE__SRV__DETAIL__PLACE__FUNCTIONS_H_
 ...
 * calls
 * plan_execute_interface__srv__Place_Request__init().
...
/**
 * It calls
 * plan_execute_interface__srv__Place_Request__fini()
 ...
 * plan_execute_interface__srv__Place_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * plan_execute_interface__srv__Place_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * plan_execute_interface__srv__Place_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_plan_execute_interface
...
/**
 * It calls
 * plan_execute_interface__srv__Place_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_plan_execute_interface
...
/**
 * It allocates the memory for the array and calls
 * plan_execute_interface__srv__Place_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_plan_execute_interface
...
/**
 * It calls
 * plan_execute_interface__srv__Place_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PLAN_EXECUTE_INTERFACE__SRV__DETAIL__PLACE__FUNCTIONS_H_
