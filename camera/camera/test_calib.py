...
class TestCalib(Node):
    ...
    def timer_callback(self):
        ...
        self.rot_base.transform.translation.y = .25125
        self.rot_base.transform.translation.x = -.25125
        z_rot_base = quaternion_from_euler(0.0, rad, 0.0)
        qz_rot_base = quaternion_multiply(og_q, z_rot)
        y_rot_base = quaternion_from_euler(0.0, 0.0, rad2)
        q_new1 = quaternion_multiply(qz_rot, y_rot)
        self.rot_base.transform.rotation.x = q_new1[0]
        self.rot_base.transform.rotation.y = q_new1[1]
        self.rot_base.transform.rotation.z = q_new1[2]
        self.rot_base.transform.rotation.w = q_new1[3]
