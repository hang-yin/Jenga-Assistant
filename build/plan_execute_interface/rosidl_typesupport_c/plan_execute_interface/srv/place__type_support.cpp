...
static const _Place_Request_type_support_symbol_names_t _Place_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plan_execute_interface, srv, Place_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plan_execute_interface, srv, Place_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plan_execute_interface, srv, Place_Request)() {
  return &::plan_execute_interface::srv::rosidl_typesupport_c::Place_Request_message_type_support_handle;
}
...
static const _Place_Response_type_support_symbol_names_t _Place_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plan_execute_interface, srv, Place_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plan_execute_interface, srv, Place_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plan_execute_interface, srv, Place_Response)() {
  return &::plan_execute_interface::srv::rosidl_typesupport_c::Place_Response_message_type_support_handle;
}
...
static const _Place_type_support_symbol_names_t _Place_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plan_execute_interface, srv, Place)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plan_execute_interface, srv, Place)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, plan_execute_interface, srv, Place)() {
  return &::plan_execute_interface::srv::rosidl_typesupport_c::Place_service_type_support_handle;
}
