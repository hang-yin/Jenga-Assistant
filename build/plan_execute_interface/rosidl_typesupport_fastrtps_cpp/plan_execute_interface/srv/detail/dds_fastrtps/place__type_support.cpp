...
#include "plan_execute_interface/srv/detail/place__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const plan_execute_interface::srv::Place_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<plan_execute_interface::srv::Place_Request *>(
    untyped_ros_message);
...
{
  return &plan_execute_interface::srv::typesupport_fastrtps_cpp::_Place_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const plan_execute_interface::srv::Place_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<plan_execute_interface::srv::Place_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &plan_execute_interface::srv::typesupport_fastrtps_cpp::_Place_Response__handle;
}
...
{
  return &plan_execute_interface::srv::typesupport_fastrtps_cpp::_Place__handle;
}
